...
input_file_3 <- "treat_C.narrowPeak.bed"

files <- c(input_file_1, input_file_2, input_file_3)
...
names(tagMatrixList) <- c("treat_A", "treat_B", "treat_C")
...
names(tagMatrixList_TTS) <- c("treat_A", "treat_B", "treat_C")
...
names(genes) <- c("treat_A", "treat_B", "treat_C")
vennplot(genes)
